...
export const tools: ToolDefinition[] = [
    ...
    { id: "pdf-to-word", title: "PDF به Word", description: "تبدیل فایل PDF متنی به سند Word قابل ویرایش؛ پشتیبانی OCR برای فایل‌های اسکن‌شده.", icon: "📄", category: "general", type: "normal", href: "/tools/pdf-to-word", featured: true, enabled: true, seoTitle: "تبدیل PDF به Word آنلاین | PDF to DOCX | توسن", seoDescription: "فایل PDF متنی یا اسکن‌شده خود را به Word قابل ویرایش تبدیل کنید. ابزار آنلاین PDF to Word توسن.", indexable: true },
    { id: "pdf-manager", title: "مدیریت PDF", description: "مجموعه ابزار PDF برای ادغام، تقسیم، فشرده‌سازی و تبدیل عکس به PDF در یک محیط.", icon: "🗂️", category: "general", type: "normal", href: "/tools/pdf-manager", featured: true, enabled: true, seoTitle: "مدیریت PDF آنلاین | PDF Manager | ادغام، تقسیم و فشرده‌سازی PDF | توسن", seoDescription: "مدیریت PDF آنلاین با تب‌های جداگانه برای ادغام PDF، تقسیم PDF، کاهش حجم PDF و تبدیل عکس به PDF؛ سریع و مناسب موبایل.", indexable: true },
    { id: "pdf-merge", title: "ادغام PDF", description: "چند فایل PDF را در یک فایل واحد ترکیب کنید.", icon: "🔗", category: "general", type: "normal", href: "/tools/pdf-manager/merge-pdf", featured: false, enabled: true, seoTitle: "ادغام PDF آنلاین | Merge PDF | ترکیب چند فایل PDF | توسن", seoDescription: "چند فایل PDF را آنلاین و رایگان در یک فایل واحد ادغام کنید. Merge PDF با مرتب‌سازی فایل‌ها و پردازش داخل مرورگر.", indexable: true },
    { id: "pdf-split", title: "تقسیم PDF", description: "صفحات دلخواه PDF را جدا و در یک فایل جدید دریافت کنید.", icon: "✂️", category: "general", type: "normal", href: "/tools/pdf-manager/split-pdf", featured: false, enabled: true, seoTitle: "تقسیم PDF آنلاین | Split PDF | جدا کردن صفحات PDF | توسن", seoDescription: "صفحات دلخواه یک PDF را جدا کنید و فایل جدید بسازید. ابزار Split PDF توسن برای استخراج بازه صفحات آنلاین.", indexable: true },
    { id: "pdf-compress", title: "کاهش حجم PDF", description: "PDF را دوباره‌سازی و بهینه کنید و حجم فایل خروجی را مقایسه کنید.", icon: "🗜️", category: "general", type: "normal", href: "/tools/pdf-manager/compress-pdf", featured: false, enabled: true, seoTitle: "کاهش حجم PDF آنلاین | Compress PDF | فشرده‌سازی PDF | توسن", seoDescription: "حجم فایل PDF را آنلاین کاهش دهید و حجم قبل و بعد را مقایسه کنید. Compress PDF توسن بدون نصب نرم‌افزار.", indexable: true },
    { id: "image-to-pdf", title: "عکس به PDF", description: "یک یا چند تصویر JPG و PNG را به فایل PDF تبدیل کنید.", icon: "🖼️", category: "general", type: "normal", href: "/tools/pdf-manager/image-to-pdf", featured: false, enabled: true, seoTitle: "تبدیل عکس به PDF آنلاین | JPG to PDF | تصویر به PDF | توسن", seoDescription: "چند عکس JPG یا PNG را آنلاین به یک فایل PDF تبدیل کنید. مناسب مدارک، اسکن‌ها و ارسال فایل در سامانه‌ها.", indexable: true },
    ...
    { id: "average-calculator", title: "محاسبه معدل", description: "محاسبه معدل ترمی، معدل کل و میانگین نمرات با ضرایب واحدها.", icon: "🎓", category: "general", type: "normal", href: "/tools/average-calculator", featured: true, enabled: true, seoTitle: "محاسبه معدل آنلاین | GPA & Average Calculator | توسن", seoDescription: "معدل ترمی و میانگین نمرات را آنلاین محاسبه کنید؛ مناسب دانش‌آموزان و دانشجویان با امکان وارد کردن واحد و نمره.", indexable: true },
    { id: "age-calculator", title: "محاسبه سن", description: "محاسبه سن دقیق بر اساس تاریخ تولد شمسی و میلادی.", icon: "🎂", category: "general", type: "normal", href: "/tools/age-calculator", featured: true, enabled: true, seoTitle: "محاسبه سن آنلاین | Age Calculator | سن دقیق به سال و ماه و روز | توسن", seoDescription: "سن دقیق خود را بر اساس تاریخ تولد محاسبه کنید. Age Calculator آنلاین با نمایش سن به سال، ماه و روز.", indexable: true },
