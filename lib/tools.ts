...
export const tools: ToolDefinition[] = [
    ...
    { id: "pdf-to-word", title: "PDF به Word", description: "تبدیل فایل PDF متنی به سند Word قابل ویرایش؛ پشتیبانی OCR در مرحله بعد اضافه می‌شود.", icon: "📄", category: "general", type: "normal", href: "/tools/pdf-to-word", featured: true, enabled: true },
    { id: "resume-builder", title: "رزومه‌ساز", description: "ساخت رزومه حرفه‌ای با ویرایش زنده، سوابق کاری و تحصیلی، مهارت‌ها و خروجی قابل چاپ.", icon: "📋", category: "general", type: "normal", href: "/tools/resume-builder", featured: true, enabled: true },
    ...
    { id: "thesis-idea-ai", title: "ایده پایان‌نامه", description: "کمک برای پیدا کردن و توسعه ایده‌های مناسب پایان‌نامه.", icon: "🎓", category: "general", type: "ai", href: "/tools/thesis-idea", featured: true, enabled: true },
