...
export const tools: ToolDefinition[] = [
    { id: "invoice-builder", title: "فاکتورساز", description: "ساخت سریع فاکتورهای ساده و قابل چاپ.", icon: "🧾", category: "general", type: "normal", href: "/tools/invoice", featured: true, enabled: false },
