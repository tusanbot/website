...
export default async function ServicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Old indexed UUID URLs can outlive a service record. Do not leave those URLs as
  // hard 404s: send stale UUID requests to the canonical service index instead.
