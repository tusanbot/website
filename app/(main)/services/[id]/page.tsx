...
function getSeoContent(content: any) {
  ...
  return {
    introduction: typeof content.introduction === "string" ? content.introduction.trim() : "",
    audience: typeof content.audience === "string" ? content.audience.trim() : "",
    steps: Array.isArray(content.steps) ? content.steps.filter((x: any) => x && typeof x === "object").slice(0, 6) : [],
    tips: Array.isArray(content.tips) ? content.tips.filter((x: any) => typeof x === "string" && x.trim()).slice(0, 6) : [],
    faq: Array.isArray(content.faq) ? content.faq.filter((x: any) => x && typeof x === "object").slice(0, 8) : [],
