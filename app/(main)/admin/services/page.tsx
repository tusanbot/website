    ...
    return (
        <div dir="rtl" className="min-h-screen page-background text-[var(--text)] p-6 transition-colors duration-300">
            <div className="max-w-6xl mx-auto">
                ...
                <TusanTable
                    columns={[
                        { key: "icon", title: "آیکون", width: "80px", align: "center" },
                        { key: "title", title: "عنوان" },
                        { key: "category", title: "دسته‌بندی" },
                        { key: "price", title: "قیمت", align: "left" },
                    ...
                    emptyTitle="هنوز هیچ خدمتی ثبت نشده است"
                    emptyDescription="برای شروع، اولین خدمت را از طریق دکمه «خدمت جدید» ایجاد کنید."
                />
            </div>
        </div>
    );
