...
export default function EditAnnouncementPage() {
    ...
    async function loadAnnouncement() {
        ...
        try {
            ...
            if (error || !data) {
                throw new Error("اطلاعیه موردنظر پیدا نشد.");
            }
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    <SectionHeader
                        ...
                        description="اطلاعات اطلاعیه یا ثبت‌نام را ویرایش کنید."
                    />
                ...
                <GlassPanel className="p-6">
                    {error && (
                        <div className="mb-5 rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-red-600">
                            {error}
                        </div>
                    )}
