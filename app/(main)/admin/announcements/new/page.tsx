                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            اطلاعیه یا ثبت‌نام جدید را ایجاد کنید تا در اسلایدر خدمات و صفحه
                            ثبت‌نام‌های فعال نمایش داده شود.
                        </p>
                    </div>

                    <Link
                        href="/admin/announcements"
                        className="bg-white border border-gray-200 px-5 py-3 rounded-xl hover:bg-gray-50 transition text-center"
                    >
                        ← بازگشت
                    </Link>
                </div>
