...
export default function FormBuilder() {
  ...
  return <main dir="rtl" className="min-h-screen page-background py-7 md:py-10">
    <style jsx global>{`@media print{body *{visibility:hidden!important}.print-area,.print-area *{visibility:visible!important}.print-area{position:absolute!important;inset:0!important;width:100%!important;padding:8mm!important}.no-print{display:none!important}.print-copy{break-after:page;page-break-after:always}.print-copy:last-child{break-after:auto;page-break-after:auto}}`}</style>
