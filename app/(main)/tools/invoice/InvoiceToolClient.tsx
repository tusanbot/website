    ...
    <main dir="rtl" className="min-h-screen page-background p-4 sm:p-6">
      <div className="mx-auto max-w-[1500px]">
        ...
        <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
          ...
          <aside className="no-print order-1 xl:order-2 rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-sm xl:sticky xl:top-5"><div><h2 className="text-lg font-black">تنظیمات فاکتور</h2><p className="mt-1 text-xs text-[var(--text-muted)]">اطلاعات و ظاهر فاکتور را از اینجا تنظیم کنید.</p></div>
            <div className="mt-5 space-y-3"><label className="block text-sm font-bold">صادرکننده<input value={seller} onChange={(e)=>setSeller(e.target.value)} className="mt-2 w-full rounded-xl border border-[var(--border)] bg-transparent px-3 py-2 font-normal"/></label><label className="block text-sm font-bold">نام مشتری<input value={customer} onChange={(e)=>setCustomer(e.target.value)} className="mt-2 w-full rounded-xl border border-[var(--border)] bg-transparent px-3 py-2 font-normal"/></label><div className="grid grid-cols-2 gap-2"><label className="text-sm font-bold">شماره تماس<input value={phone} onChange={(e)=>setPhone(e.target.value)} className="mt-2 w-full rounded-xl border border-[var(--border)] bg-transparent px-3 py-2 font-normal"/></label><label className="text-sm font-bold">شماره فاکتور<input value={invoiceNo} onChange={(e)=>setInvoiceNo(e.target.value)} className="mt-2 w-full rounded-xl border border-[var(--border)] bg-transparent px-3 py-2 font-normal"/></label></div><label className="block text-sm font-bold">تاریخ<input value={date} onChange={(e)=>setDate(e.target.value)} className="mt-2 w-full rounded-xl border border-[var(--border)] bg-transparent px-3 py-2 font-normal"/></label></div>
