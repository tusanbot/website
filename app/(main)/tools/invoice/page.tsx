...
const SITE_URL = "https://tusan-cyber.vercel.app";
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div ref={invoiceRef} className="invoice-paper mx-auto bg-white text-slate-900 shadow-xl print:shadow-none">
          <div className="p-6 sm:p-10">
            ...
            <footer className="invoice-footer mt-12 border-t border-slate-300 pt-4 text-center text-xs text-slate-500">فاکتور ساز رایگان توسن · {SITE_URL}</footer>
          </div>
        </div>
      </div>
