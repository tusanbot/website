...
export default function DashboardPage() {
    ...
    if (loading) {
        return (
            <div
                dir="rtl"
                className="min-h-screen page-background text-[var(--text)]"
            >
                <UserNavbar />
    ...
    return (
        ...
        >
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
                <GlassPanel
                    className="p-6 sm:p-8 text-white overflow-hidden relative"
                >
                    <div
                    ...
                    <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                        <div>
                            ...
                            <p className="text-white/80 mt-2 max-w-2xl leading-7">
                                از اینجا می‌توانید سفارش‌ها، پیام‌ها و خدمات خود را به‌صورت یکپارچه مدیریت و پیگیری کنید.
                            </p>
                        </div>
                ...
                <section className="space-y-4">
                    <SectionHeader
                        title="دسترسی سریع"
                        description="بخش موردنظر خود را انتخاب کنید"
                    />
