...
export default function DiscountManagement(){
 const [tags,setTags]=useState<Tag[]>([]); const [discounts,setDiscounts]=useState<Discount[]>([]); const [links,setLinks]=useState<LinkRow[]>([]); const [users,setUsers]=useState<User[]>([]);
 ...
 async function load(){
  ...
  try{
   ...
   setTags((t.data||[]) as Tag[]);setDiscounts((d.data||[]) as Discount[]);setLinks((l.data||[]) as LinkRow[]);setUsers((u.users||[]) as User[]);
