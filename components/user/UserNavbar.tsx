            ...
            <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--surface)]/80 backdrop-blur-md transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="h-16 flex items-center justify-between gap-4">
                        ...
                        >
                            <div className="w-10 h-10 rounded-xl bg-[var(--primary)] text-white flex items-center justify-center font-bold shadow-[var(--shadow-sm)]">
                                ت
                            </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="md:hidden w-10 h-10 rounded-xl bg-[var(--surface-muted)] flex items-center justify-center text-xl text-[var(--text)] border border-[var(--border)]"
                        ...
                        <GlassPanel className="md:hidden mt-2 p-3 border border-[var(--border)]">
                            <div className="space-y-1">
                                ...
                                <Link
                                    href="/services"
                                    onClick={() => setOpen(false)}
                                    className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[var(--surface-muted)] text-[var(--text)] font-medium border border-[var(--border)]"
                                >
                                    <span>＋</span>
                                    سفارش جدید
                                </Link>
