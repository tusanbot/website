...
export default function AppSidebar({
    ...
    return (
        <GlassPanel
            className={`h-full flex flex-col ${mobile ? "rounded-none border-0" : "rounded-3xl"
                }`}
        >
            <div className="p-5 border-b border-[var(--border)]">
                ...
                {role === "guest" ? (
                    <div className="mt-3">
                        <Link href="/auth?mode=login" onClick={() => onClose?.()}>
                            <TusanButton className="w-full">ورود / ثبت‌نام</TusanButton>
                        </Link>
                    </div>
                ) : (
                    <div className="mt-3">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
                <div>
                    <div className="mb-2 text-xs font-bold text-[var(--text-muted)]">
                        عمومی
                    </div>
