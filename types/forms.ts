...
export type FormField = { id: string; type: FieldType; label: string; name: string; placeholder?: string; description?: string; required: boolean; options?: FormOption[]; conditions?: FieldCondition[]; conditionLogic?: "AND" | "OR"; defaultValue?: string | number | boolean | string[]; validation?: FieldValidationRules; min?: number; max?: number; fields?: FormField[]; minItems?: number; maxItems?: number };
